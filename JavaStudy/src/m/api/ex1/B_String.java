...
public class B_String {
	...
	public void mathod01() {
		...
		// String클래스에서 hashCode메소드 이미 오버라이딩이 되어있다.(주소값이 아닌 문자열을 가지고 만들도록)
		...
		public void mathod02() {
			...
			System.out.println(str1.subSequence(6, 9));
...
//			System.out.println(stn.countTokens()); // 더이상 토큰이 남아있지 않을 때 다음 토큰을 가져오려고하면 예외발생!
