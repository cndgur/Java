...
//		ArrayList list
		...
		System.out.println(list); // list의 특징 : 순서를 유지하면서 담김(0번인덱스 부터 차곡차곡)
		
		//2. add(index, E e) : 직접 인덱스를 지정해서 해당 위치에 데이터를 추가할 수 있다.
		...
		//4. set(int index, E e) : 해당 인덱스위치의 값을 전달받은 e객체로 변경
